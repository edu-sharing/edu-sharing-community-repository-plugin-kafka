...
class UserDataServiceTest {
    ...
    private static Stream<Arguments> setUserDataTestParameter() {
        ...
        List<UserDataDTO> newUserDataDto = List.of(
                new UserDataDTO("Lenny", "Linux", "lenny.linux@example.com", "de_DE", NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately),
                new UserDataDTO("William", "Windows", "william.windows@example.com", "de_DE", NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately),
                new UserDataDTO("Scala", "Johansson", "scala.johansson@example.com", "de_DE", NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately, NotificationIntervalDTO.immediately)
        );
