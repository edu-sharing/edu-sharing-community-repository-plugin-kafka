...
@SuperBuilder
@NoArgsConstructor
@TypeAlias("AddToInboxEvent")
@Document(collection = "notification")
public class AddToInboxEvent extends NodeBaseEvent {

    public AddToInboxEvent(String id, Date timestamp, String creatorId, String receiverId, Status status, NodeData node) {
