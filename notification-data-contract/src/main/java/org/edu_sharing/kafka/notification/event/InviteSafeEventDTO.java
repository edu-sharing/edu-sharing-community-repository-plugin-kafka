...
public class InviteSafeEventDTO extends NodeBaseEventDTO {
    public InviteSafeEventDTO(String id, Date timestamp, String creatorId, String receiverId, StatusDTO status, NodeDataDTO node, String name, String userComment, List<PermissionDTO> permissions) {
